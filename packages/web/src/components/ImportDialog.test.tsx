...
describe("ImportDialog", () => {
  ...
  it("renders dialog when open=true", () => {
    render(<ImportDialog open={true} onClose={vi.fn()} onImport={vi.fn()} />);
  ...
  it("clicking close button calls onClose", () => {
    const onClose = vi.fn();
    render(<ImportDialog open={true} onClose={onClose} onImport={vi.fn()} />);
  ...
  it("dropping a valid .json file calls onImport with parsed nodes and edges", async () => {
    ...
    render(<ImportDialog open={true} onClose={vi.fn()} onImport={onImport} />);
