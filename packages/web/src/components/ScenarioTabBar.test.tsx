...
describe('ScenarioTabBar', () => {
  ...
  it('active tab has the font-semibold class', () => {
    ...
    const tabButton = allButtons.find((b) => b.textContent?.includes('Scenario 1') && b.className.includes('font-semibold'));
  ...
  it('clicking an inactive tab calls onSwitch with that scenario id', () => {
    ...
    const allButtons = screen.getAllByRole('button');
    const inactiveTab = allButtons.find((b) => b.textContent?.includes('Scenario 2') && !b.className.includes('font-semibold'));
